...
COPY --from=builder /go/src/github.com/newrelic/nri-haproxy/legacy/haproxy-definition.yml /nri-sidecar/newrelic-infra/newrelic-integrations/definition.yml
USER 1000
