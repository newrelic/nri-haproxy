...
For installation and usage instructions, see our [documentation web site](https://docs.newrelic.com/docs/integrations/host-integrations/host-integrations-list/haproxy-monitoring-integration).
...
After cloning this repository, go to the directory of the HAProxy integration and build it:
...
If you want to know more about usage of `./bin/nri-haproxy`, pass the `-help` parameter:
...
We encourage your contributions to improve the HAProxy integration! Keep in mind when you submit your pull request, you'll need to sign the CLA via the click-through using CLA-Assistant. You only have to sign the CLA one time per project.
...
## License
nri-haproxy is licensed under the [Apache 2.0](http://apache.org/licenses/LICENSE-2.0.txt) License.